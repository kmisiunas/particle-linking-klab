...
class FindTest extends FunSuite {
  ...
  val pt1 = Track(1, List( Pos(10,1,1), Pos(11,1.3,1), Pos(12,1.2,1), Pos(13,1.1,1), Pos(14,2,2) ))
  val pt2 = Track(2, List( Pos(12,2,3), Pos(13,1.3,1), Pos(14,1.2,1), Pos(15,1.1,1), Pos(16,2,2) )) //special
  val pt3 = Track(3, List( Pos(20,2,3), Pos(21,1.3,1), Pos(23,1.1,1), Pos(24,2,2),   Pos(25,1.2,1) ))
  val pt4 = Track(4, List( Pos(15,2,3), Pos(16,1.3,1), Pos(17,1.1,1), Pos(18,2,2),   Pos(19,1.2,1), Pos(20,1.2,1), Pos(21,1.2,1), Pos(22,1.2,1),Pos(23,1.2,1),Pos(23,1.3,1),Pos(24,1.2,1),Pos(25,1.2,1),Pos(26,1.2,1) ))
  val pt5 = Track(5, List( Pos(10,1,1), Pos(11,1.3,1), Pos(12,1.2,1), Pos(13,1.1,1), Pos(14,8,8) ))
  val pt6 = Track(6, List(  Pos(13,9,1), Pos(14,8,8) ))
  ...
  test("Find.alignTwoTracks( Track, Track )") {
