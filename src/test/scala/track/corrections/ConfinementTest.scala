...
class ConfinementTest extends FunSuite {
  ...
  val pt6 = ParticleTrack(1, List( Pos(10,0,1), Pos(11,1,1), Pos(12,2,1),Pos(13,3),  Pos(14,2),   Pos(15,3), Pos(16,4), Pos(17,6.5), Pos(18,8) ))
  val pt7 = ParticleTrack(2, List(              Pos(11,5),   Pos(12,4),  Pos(13,3.1),Pos(14,4,2), Pos(15,5), Pos(16,5.5),Pos(17,6), Pos(18,6.5) ))
